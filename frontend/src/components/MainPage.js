...
function MainPage() {
    ...
    const [queryResult, setQueryResult] = React.useState([{email: "test@email", phone: 111},{email: "test@email", phone: 123}])
        ...
        <div>
            <Container>
                ...
                <div>
                    <div>{_spacing(10)}</div>
                    <div>
                        <TextField fullWidth id="email_tb" label="Search for email" variant="outlined" onChange={(e) => setEmailQuery(e.target.value)}></TextField>
                    </div>
                    <div>
